/*
  ...
  - The values [applied,shortlisted,interview,hired,rejected] on the enum `ApplicationStatus` will be removed. If these variants are still used in the database, this will fail.
