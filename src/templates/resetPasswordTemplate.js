...
<head>
  ...
  <title>LaunchConnect Email</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; max-width: 600px; margin: 0 auto;">
              ...
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="padding-left: 10px; vertical-align: middle;">
                    <span style="color: #4a5568; font-weight: 600; font-size: 20px;">Launch</span>
                    <span style="color: #4a5568; font-weight: 400; font-size: 20px;">Connect</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin-bottom: 24px; font-size: 16px; color: #111827;">Hey ${name}</p>
              
              <p style="margin-bottom: 24px; font-size: 16px; color: #111827;">${resetLink}</p>
              
              <p style="margin-bottom: 24px; font-size: 16px; color: #111827;">This code <b>expires in ${resetTokenExpiry} minite(s)</b>.</p>
              
              <div style="margin-top: 32px;">
                <p style="margin-bottom: 8px; font-size: 16px; color: #111827;">Best,</p>
                <p style="margin-bottom: 0; font-size: 16px; color: #111827;">LaunchConnect Team</p>
              </div>
            </td>
          </tr>
